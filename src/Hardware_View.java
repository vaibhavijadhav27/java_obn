...
public class Hardware_View {
	 ...
	 */
	public Hardware_View(int check) {
		initialize(check);
	}
	...
	private void initialize(int check) {
		...
		String u_name = "root";
		String r_pass = ""; 
		String query = "SELECT * FROM post WHERE section = 'Hardware' ORDER BY p_date DESC ";
		String uname = "";
		String query2 = "SELECT * FROM users WHERE user_id = '"+check+"'";
		
		frame.setTitle("The One Byte News - Hardware");
		int i = 10;
